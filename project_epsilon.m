...
function xdot = project_epsilon(t, x)
...
kxdot = -gammax*eye(3)*(x(4:6,1)*(e')*P*B*sign(lambda)+norm(e'*P*B)*sigmax*kxdot1);	% This is kx dot.(3x3 matrix)
xdot(7:9,1) = kxdot(1,:);
xdot(10:12,1)= kxdot(2,:);
xdot(13:15,1) = kxdot(3,:);

krdot = -gammar*eye(3)*(r*(e')*P*B*sign(lambda)+norm(e'*P*B)*sigmar*krdot1); % This is kr dot.(3x3 matrix)
